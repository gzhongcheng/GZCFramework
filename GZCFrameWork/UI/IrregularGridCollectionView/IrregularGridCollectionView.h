 ...
 *
 *  @param irregularGridCollectionView CollectionGridView's object.
...
/**
 irregularGridCollectionView did sccroll event

 @param collectionView scrollView
 */
- (void)irregularGridCollectionViewDidScroll:(UICollectionView *)collectionView;
