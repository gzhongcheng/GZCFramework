...
- (void)setMessage:(UUMessage *)message{
    ...
    if (_showTime){
        ...
        CGSize timeSize = [_message.strTime textSizeWithFont:ChatTimeFont constrainedToSize:CGSizeMake(300, 100) lineBreakMode:NSLineBreakByWordWrapping];
    ...
    switch (_message.type) {
        case UUMessageTypeText:
            contentSize = [_message.strContent textSizeWithFont:ChatContentFont constrainedToSize:CGSizeMake(ChatContentW, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
        ...
        case UUMessageTypeVoice:
            contentSize = CGSizeMake(120, 18);
            break;
        case UUMessageTypeLink:
            contentSize = CGSizeMake(230, 70);
        default:
            break;
    }
    if (_message.from == UUMessageFromMe) {
